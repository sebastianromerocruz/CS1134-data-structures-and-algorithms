...
### **Key Takeaway**
The formula `n`(`n` + 1) / 2 simplifies the sum of the first `n` integers by leveraging symmetry and pairing, saving us from manually summing all numbers.   --><h2 align=center>Week 03</h2>
